    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Pendaftar Divisi Android</h3>
            </div>
            <div class="card-body">
                <div class="row ">
                    <div class="col">
                        <form class="form-inline d-flex flex-row-reverse">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-sm border-success" id="id-divisi" placeholder="Cari Pendaftar" name="cari-pendaftar">
