    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Admin Pendaftaran WRI</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <form action="" method="post">
                            ...
                            <button class="btn btn-success btn-sm" type="submit" name="tambah-admin" id="update-admin"> <i class="fa fa-pencil-alt"></i> Tambah Admin</button>
