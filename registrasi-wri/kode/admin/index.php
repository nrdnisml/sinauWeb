...
<head>
    <meta charset="utf-8">
    <title>Admin Registrasi Calon WRI</title>
    <!-- Shortcut Icon -->
...
<body class="hold-transition login-page" style="background-color: #182538">
    <div class="login-box">

        <!-- /.login-logo -->
        <div class="card bg-dark">
            <div class="login-logo mt-3">
                <img src="dist/img/wri.png" alt="logo" width="100px">
            </div>
